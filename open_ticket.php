...
<body>
  <section id="container">
          ...
          <div class="col-md-12">
            <div class="content-panel">
              ...
              <table class="table table-striped table-advance table-hover">
                <h4 style="margin-left: 20px;"><i class="fa fa-angle-right"></i> Open Ticket</h4>
                
                <!-- <div class="row" style=" float: right;"> -->
              <!--  BUTTONS ROUND -->
              <!-- <button type="button" class="btn btn-round btn-success" style="margin-right: 10px; margin-top: 10px; margin-bottom: 20px; border-radius: 5px;"><a href="open_ticket.php" style="color: #fff;">Open</a></button> -->
              <!-- <button type="button" class="btn btn-round btn-primary" style="margin-right: 10px; margin-top: 10px; margin-bottom: 20px; border-radius: 5px;"><a href="answer.html" style="color: #fff;">Answer</button> -->
              <!-- <button type="button" class="btn btn-round btn-default" style="margin-right: 40px; margin-top: 10px; margin-bottom: 20px; border-radius: 5px;"><a href="overdue.html" style="color: #000;">Overdue</button> -->
              <!-- </div> -->
                ...
                <thead>
                  ...
                  <tr>
                    <th> </th>
                    <th><i class="fa fa-ticket"></i> Ticket</th>
                    <th class="hidden-phone"><i class="fa fa-calendar"></i> Create Date </th>
                    <th><i class=" fa fa-edit"></i> Subject </th>
                    <th><i class=" fa fa-cloud-download"></i> From</th>
                    <th><i class=" fa fa-unsorted"></i> Priority</th>
                    <th><i class=" fa fa-user"></i> Assigned To</th>
                    <th><i class=" fa fa-users"></i> Team</th>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright" style="font-size: 12px; margin-left: 150px; text-align: center; margin-top: 280px;">
